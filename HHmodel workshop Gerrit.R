...
plot_grid(pv, pn, pm, ph, ncol=2, nrow =2)


## Question 1: What exactly is plotted on the four panels? and how does it relate to 
#the spike waveform?
...
## Question 4: HH models can be used for studying ion channel diseases 
